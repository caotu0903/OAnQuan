...
public class GameScreen implements Screen {
    ...
    private void initGameOverDialog(final String winner) {
        ...
        gameOverDialog.pack();
        gameOverDialog.setPosition(WORLD_WIDTH/2 - gameOverDialog.getWidth()/2*scale,
                WORLD_HEIGHT/2 - gameOverDialog.getHeight()/2*scale);
...
//            oCo[11].setNumberCo(yTouch);
    ...
    private void initCellArray() {
        oCo = new OCo[14];
        oCo[0] = new OCo(5, false, false, false, false, WORLD_WIDTH*0.700f, WORLD_HEIGHT*0.415f, 150, 150, oCoThuongRegions[5]);
        oCo[1] = new OCo(5, false, false, false, false, WORLD_WIDTH*0.600f, WORLD_HEIGHT*0.415f, 150, 150, oCoThuongRegions[5]);
        oCo[2] = new OCo(5, false, false, false, false, WORLD_WIDTH*0.500f, WORLD_HEIGHT*0.415f, 150, 150, oCoThuongRegions[5]);
        oCo[3] = new OCo(5, false, false, false, false, WORLD_WIDTH*0.400f, WORLD_HEIGHT*0.415f, 150, 150, oCoThuongRegions[5]);
        oCo[4] = new OCo(5, false, false, false, false, WORLD_WIDTH*0.300f, WORLD_HEIGHT*0.415f, 150, 150, oCoThuongRegions[5]);
        oCo[5] = new OCo(10, true, false, true, true, WORLD_WIDTH*0.200f, WORLD_HEIGHT*0.502f, 100, 200, oCoYellow[0]);
        oCo[6] = new OCo(5, false, false, false, false, WORLD_WIDTH*0.300f, WORLD_HEIGHT*0.590f, 150, 150, oCoThuongRegions[5]);
        oCo[7] = new OCo(5, false, false, false, false, WORLD_WIDTH*0.400f, WORLD_HEIGHT*0.590f, 150, 150, oCoThuongRegions[5]);
        oCo[8] = new OCo(5, false, false, false, false, WORLD_WIDTH*0.500f, WORLD_HEIGHT*0.590f, 150, 150, oCoThuongRegions[5]);
        oCo[9] = new OCo(5, false, false, false, false, WORLD_WIDTH*0.600f, WORLD_HEIGHT*0.590f, 150, 150, oCoThuongRegions[5]);
        oCo[10] = new OCo(5, false, false, false, false, WORLD_WIDTH*0.700f, WORLD_HEIGHT*0.590f, 150, 150, oCoThuongRegions[5]);
        oCo[11] = new OCo(10, false, true, true, true, WORLD_WIDTH*0.800f, WORLD_HEIGHT*0.502f, 100, 200, oCoBlue[0]);
        oCo[12] = new OCo(0, false, false, false, false, WORLD_WIDTH*0.500f, WORLD_HEIGHT*0.180f, 300, 100, oCoThuongRegions[0]);
        oCo[13] = new OCo(0, false, false, false, false, WORLD_WIDTH*0.500f, WORLD_HEIGHT*0.850f, 300, 100, oCoThuongRegions[0]);
    }
